            ...
            <form method="post" action="" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="judul" placeholder="Tuliskan Deskripsi Gallery" value="<?= $row["deskripsi"] ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="isi">Gambar</label>
                        <textarea class="form-control" placeholder="Tuliskan Gambar Gallery" name="isi" required><?= $row["gambar"] ?></textarea>
                    </div>
                    <div class="mb-3">
